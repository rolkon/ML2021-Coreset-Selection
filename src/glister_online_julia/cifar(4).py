...
experimental_setting(train_ds, val_ds, test_dataset, torch.randn(1, 2560), 0.05, 4500, 4500, 0, 0, "stochastic_greedy", 32*32*3, 10, 100, 20, 128, CifarNet()) # ~10% of data
...
experimental_setting(train_ds, val_ds, test_dataset, torch.randn(1, 2560), 0.05, 20000, 20000, 0, 0, "stochastic_greedy", 32*32*3, 10, 100, 20, 128, CifarNet()) # ~50% of data