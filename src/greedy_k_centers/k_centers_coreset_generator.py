...
def generate_coreset_indices(dataset_type='fullset', frac_of_full_set=0.5):
    ...
    if(dataset_type=='fullset'):
        ...
        print("generate_coreset_indices: dataset type error: You have to choose either 'fullset' or 'subset'.")
